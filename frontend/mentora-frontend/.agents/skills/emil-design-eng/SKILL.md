...
> Источник: [emilkowalski/skills](https://github.com/emilkowalski/skills) (Emil Kowalski — Vercel, Linear; автор Sonner/Vaul), лицензия MIT. Скопировано без изменений как источник экспертизы по анимации/дизайну для этого проекта.
