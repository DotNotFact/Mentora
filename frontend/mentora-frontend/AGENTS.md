...
12. Если после шага 10 бэклог `schedule/` пуст — см.
    `schedule/README.md` → "Пополнение бэклога": добавь новую задачу
    (Режим A, только план), но НЕ выполняй её без отдельной команды.
